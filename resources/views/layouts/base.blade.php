                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +880 17 6705 6733</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Shwerapara, Mirpur, Dhaka, Bangladesh</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@Rainbow.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Rainbow</p>
                        <!-- <p class="mb-0 font-dark">Developed By,<a href="https://bd.linkedin.com/in/imtiaz-ahmed-shakib-04385a168">IMTIAZ AHMED</a></p> -->
                    </div>
                </div>
            </div>
        </div>
